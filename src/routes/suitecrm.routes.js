 ...
 */
router.post('/whatsapp/:accountId/chats/:phone/:contactPhone/:type', suitecrmController.handleDirectMessage);

/**
 * 2. Encolar Mensajes Singulares (Bulk / Envíos Masivos)
 * URL: POST {baseUrl}/queues/chats/singular/{phone}/{type}
 */
router.post('/queues/chats/singular/:phone/:type', suitecrmController.handleQueueMessage);
